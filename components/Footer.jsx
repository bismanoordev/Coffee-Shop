    ...
    <footer className="bg-[#30261C] ">
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            <h2 className="mb-6 text-sm font-semibold text-[#be8b63] uppercase dark:text-white">
              Company
            </h2>
        ...
        <div className="px-4 py-6 bg-[#30261C] md:flex md:items-center md:justify-between ">
