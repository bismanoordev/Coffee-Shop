        ...
        <div className="max-w-[1500px] mx-auto w-full">
          <Slider {...settings}>
            {coffees.map((coffee, index) => (
              <div key={index} className="px-2 sm:px-3 w-full flex justify-center">
                <div className="bg-[#EEEBE6] rounded-2xl shadow-md flex flex-col overflow-hidden hover:shadow-lg transition-shadow duration-300 w-full max-w-md sm:max-w-sm">
                  ...
                  <div className="p-4 sm:p-5 flex flex-col gap-2">
                    <h3 className="text-base sm:text-lg md:text-xl font-extrabold text-[#2b2015]">{coffee.title}</h3>
                    <p className="text-[#3a2c1e] text-xs sm:text-sm md:text-base leading-snug">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    </p>

                    <div className="flex items-center justify-between mt-3">
                      <p className="font-bold text-[#2b2015] text-sm sm:text-base">{coffee.price}</p>
